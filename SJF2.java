...
public class SJF2 {
	...
	public static void a2(){
		System.out.println("Œredni czas oczekiwania procesów dla algorytmu SJF2 to: " + sred/liczbaCiagow + " milisekund");
	}
	public SJF2(CiagProcesow lista){
		try {
			pom = lista.clone();
